 ...
 * <ul>
 *     <li>
 *         Per user by request, I've changed the signature of
 *         {@code State.getOutputs()} and {@code SearchResults.getOutputs()}
 *         to Sets rather than Lists.
 *     </li>
 *
 * </ul>
 *
 * tweaked to be type generic
