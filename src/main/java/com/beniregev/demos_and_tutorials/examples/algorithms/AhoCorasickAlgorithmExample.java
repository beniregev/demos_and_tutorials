...
public class AhoCorasickAlgorithmExample {
    ...
    static int[] f = new int[maxNumberOfStates];

    // GOTO FUNCTION (OR TRIE) IS IMPLEMENTED USING g[][]
    static int[][] g = new int[maxNumberOfStates][maxNumberOfCharacters];
    ...
    static int buildMatchingMachine(String[] arr, int k) {
        ...
        for (int ch = 0; ch < maxNumberOfCharacters; ++ch)
            if (g[0][ch] == -1)
                g[0][ch] = 0;
    ...
    public static void main(String[] args) {
        ...
        searchWords(arr, arrayLength, textToSearch);
    }
}
