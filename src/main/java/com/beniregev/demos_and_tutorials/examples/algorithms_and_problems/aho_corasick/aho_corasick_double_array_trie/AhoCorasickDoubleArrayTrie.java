package com.beniregev.demos_and_tutorials.examples.algorithms_and_problems.aho_corasick.aho_corasick_double_array_trie;
...
public class AhoCorasickDoubleArrayTrie<V> implements Serializable {
     ...
     * @throws IOException If it can't read the file from path
...
//    }
    ...
    private class Builder {
        ...
        private void insert(Queue<Map.Entry<Integer, List<Map.Entry<Integer, State>>>> siblingQueue) {
            ...
            outer:
            // base[begin + a1...an]  == a1...an siblings
            while (true) {
                pos++;
